...
const Header = () => {
    ...
    return (
        <div className="flex flex-wrap md:flex-row flex-col items-center gap-y-9 gap-x-8 bg-red-300">
            ...
            <div className="flex-1">
                ...
                <div className="flex flex-wrap items-center gap-y-1 gap-x-4 mt-2">
                   ...
                   <HeaderInfo Icon={ <BsFillTerminalFill className="text-violet-700 dark:text-zinc-400" size={16}  />} title= {experience}/>
